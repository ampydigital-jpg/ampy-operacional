...
export default async function ClientesPage() {
  ...
  const [
    ...
    supabase
      ...
      .select(
        'id,client_id,service_catalog_id,responsible_id,status,started_at,monthly_quantity,quantity_unit,delivered_quantity,cycle_duration_days,requires_alignment_meeting,requires_capture,default_capture_type,notes,created_at',
      )
      .order('created_at'),
