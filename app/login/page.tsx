    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#0C0C0C', padding: '20px' }}>
      <div style={{ width: '100%', maxWidth: '360px', background: '#101010', border: '0.5px solid #1C1C1C', borderRadius: '14px', padding: '32px' }}>
        <div style={{ marginBottom: '28px' }}>
          ...
          <div style={{ fontSize: '11px', color: '#3A3A3A', marginTop: '3px' }}>Gerenciador Operacional</div>
        </div>
        <form onSubmit={handleLogin}>
          <div style={{ marginBottom: '14px' }}>
            ...
            <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="seu@email.com.br" required style={{ width: '100%', padding: '9px 12px', background: '#141414', border: '0.5px solid #242424', borderRadius: '7px', color: '#E0E0E0', fontSize: '12px', outline: 'none' }} />
          </div>
          <div style={{ marginBottom: '20px' }}>
            ...
            <input type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="••••••••" required style={{ width: '100%', padding: '9px 12px', background: '#141414', border: '0.5px solid #242424', borderRadius: '7px', color: '#E0E0E0', fontSize: '12px', outline: 'none' }} />
          </div>
          ...
          <button type="submit" disabled={loading} style={{ width: '100%', padding: '10px', background: loading ? '#555' : '#FFFFFF', border: 'none', borderRadius: '7px', color: '#0C0C0C', fontSize: '12px', fontWeight: 600, cursor: loading ? 'not-allowed' : 'pointer' }}>
